...
test('process people', (t) => {
    ...
    const person1 = new Person(
        "John Doe",
        new Placement(Element.ARIES, 25),       // asc
    ...
    const person2 = new Person(
        "Jane Doe",
        new Placement(Element.ARIES, 1),        // asc
