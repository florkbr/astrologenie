...
import { House, HouseNumber, HouseStat } from '../types/House';
import { HouseCalculator } from './HouseCalculator';
import { HouseOverlay } from '../types/HouseOverlay';
...
test('house calculator yields the expected results', (t) => {
    ...
    expectedHouseOverlays.push(new HouseOverlay(firstPerson, secondPerson, firstPerson.getHouse2(), Element.RISING, secondPerson.getRising(), HouseStat.HOUSE_2 * 1));
    expectedHouseOverlays.push(new HouseOverlay(firstPerson, secondPerson, firstPerson.getHouse3(), Element.MOON, secondPerson.getMoon(), HouseStat.HOUSE_3 * 1));
    expectedHouseOverlays.push(new HouseOverlay(firstPerson, secondPerson, firstPerson.getHouse6(), Element.SUN, secondPerson.getSun(), HouseStat.HOUSE_6 * 1));
    expectedHouseOverlays.push(new HouseOverlay(firstPerson, secondPerson, firstPerson.getHouse10(), Element.MARS, secondPerson.getMars(), HouseStat.HOUSE_10 * 5));
    expectedHouseOverlays.push(new HouseOverlay(firstPerson, secondPerson, firstPerson.getHouse11(), Element.MERCURY, secondPerson.getMercury(), HouseStat.HOUSE_11 * 4));

    // Second person's overlays
    expectedHouseOverlays.push(new HouseOverlay(secondPerson, firstPerson, secondPerson.getHouse2(), Element.RISING, firstPerson.getRising(), HouseStat.HOUSE_2 * 1));
    expectedHouseOverlays.push(new HouseOverlay(secondPerson, firstPerson, secondPerson.getHouse3(), Element.MOON, firstPerson.getMoon(), HouseStat.HOUSE_3 * 1));
    expectedHouseOverlays.push(new HouseOverlay(secondPerson, firstPerson, secondPerson.getHouse6(), Element.SUN, firstPerson.getSun(), HouseStat.HOUSE_6 * 1));
    expectedHouseOverlays.push(new HouseOverlay(secondPerson, firstPerson, secondPerson.getHouse10(), Element.MARS, firstPerson.getMars(), HouseStat.HOUSE_10 * 5));
    expectedHouseOverlays.push(new HouseOverlay(secondPerson, firstPerson, secondPerson.getHouse11(), Element.MERCURY, firstPerson.getMercury(), HouseStat.HOUSE_11 * 4));
    ...
    t.is(houseOverlays.length, expectedHouseOverlays.length, "unexpected number of result elements received from the house calculator");
    ...
    for (const expectedHouseOverlay of expectedHouseOverlays) {
        ...
        for (const houseOverlay of houseOverlays) {
            ...
            if ((expectedHouse.getElement() !== resultHouse.getElement()) || (expectedHouse.getNumber() !== resultHouse.getNumber()) || (expectedHouse.getStat() !== expectedHouse.getStat())) {
                continue;
            }
            ...
            if ((expectedPlacement.getElement() !== resultPlacement.getElement()) || (expectedPlacement.getDegrees() !== resultPlacement.getDegrees())) {
                continue;
            }
        ...
        if (!found) {
            ...
            t.fail(`expected house overlay was not found in the resulting house overlays from the house calculator`);
        }
    }
